...
parser = argparse.ArgumentParser(description='Extract projects matching some pattern; write updates to output .json file')
...
parser.add_argument('p', metavar='PATTERN', default='.*', nargs='?', type=str, help='Regex pattern or word -- defaults to .*')
