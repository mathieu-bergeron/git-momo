...
parser = argparse.ArgumentParser(description='Find students in db.json by matching some pattern against student names and ids')
...
if __name__ == '__main__':
    ...
    for student in semester.find_students(matcher):
        print("%s %s %s %s %s" % (student.fullname(), student.registration_id, student.linux_id, student.anon_id, ",".join(student.emails)))
